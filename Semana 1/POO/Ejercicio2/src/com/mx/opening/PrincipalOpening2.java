...
public class PrincipalOpening2 {
	...
	private static MenuHelper menuEditar = new MenuHelper("GUARDAR CAMBIOS");
			...
			if(auxOpening == null) {
				...
				do {
					...
					try {
						...
						scanner.nextLine();
						bloqueMenuActualizar(opcionMenuEditar, leerAtributo);
					}catch(InputMismatchException e){
						System.err.println(e+" Ingresa un tipo de dato entero!!");
						scanner.nextLine();
						opcionMenuEditar = -1;
				...
				openingImpl.update(indiceABuscar, auxOpening);
			}
			break;
		case 2:
	...
	private static void bloqueMenuActualizar(int opcion, ScannerOpeningAttr leerAtributo) {
		boolean atributoAceptado;
		switch(opcion) {
		case 0:
			System.out.println(opcion+".- Editar nombre");
			System.out.print("Ingresa el nuevo nombre del  Opening: ");
			leerAtributo.leeNombre();
			break; 
		case 1:
			System.out.println(opcion+".- Editar anime");
			System.out.print("Ingresa el nuevo anime del Opening: ");
			leerAtributo.leeAnime();
			break;
		case 2:
			System.out.println(opcion+".- Editar autor");
			System.out.print("Ingresa el nuevo autor del Opening: ");
			leerAtributo.leeAutor();
			break;
		case 3:
			System.out.println(opcion+".- Editar numero de opening");
			do {
				System.out.print("Ingresa el nuevo numero de Opening: ");
				atributoAceptado = leerAtributo.leeNumeroOpening();
				if(!atributoAceptado) {
					System.out.println("Intenta de nuevo");
				}
		...
		case 4:
			...
			do {
				System.out.print("Ingresa los nuevos minutos de duracion: ");
				atributoAceptado = leerAtributo.leeMinutosDuracion();
				if(!atributoAceptado) {
					System.out.println("Intenta de nuevo");
				}
		...
		case 5:
			...
			do {
				System.out.print("Ingresa los nuevos segundos de duracion: ");
				atributoAceptado = leerAtributo.leeSegundosDuracion();
				if(!atributoAceptado) {
					System.out.println("Intenta de nuevo");
				}
