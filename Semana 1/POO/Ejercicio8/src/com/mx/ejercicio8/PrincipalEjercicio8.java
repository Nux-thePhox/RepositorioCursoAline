...
import com.mx.ejercicio8.lambda.IPromedio;
...
public class PrincipalEjercicio8 {
	public static void main(String[] args) {
		...
		System.out.println("=============== PRACTICA LAMBDA 4. ===============");
		System.out.println("Estudiantes que estudian medicina: ");
		lista.stream()
		.filter(alumnoX -> alumnoX.getCarrera().equalsIgnoreCase("Medicina"))
		.forEach(aluX -> System.out.println(" - Nombre: "+aluX.getNombre()));
		
		//Mapear los nombres de los alumnos a mayusculas
		System.out.println("=============== PRACTICA LAMBDA 5. ===============");
		System.out.println("Nombres en mayuscula: ");
		lista.forEach(aluX -> System.out.println(" - Nombre: "+aluX.getNombre().toUpperCase()));
		
		//Calcular el promedio de las edades de todos los alumnos 
		System.out.println("=============== PRACTICA LAMBDA 5. ===============");
		System.out.println("Promedio de edades: ");
		IPromedio unPromedio = alumnos -> {
			OptionalDouble average = alumnos.stream()
					.mapToInt(Alumno::getEdad)
					.average();
			return average.isPresent() ? average.getAsDouble() : 0.0;
		};
		
		double average = unPromedio.calculaPromedio(lista);
		System.out.println("Promedio de las edades: "+average);
