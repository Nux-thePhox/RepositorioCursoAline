...
public abstract class Profesionista {
	...
	public Profesionista(String nombre, String apellido, int edad, int cedula, String universidad) {
		this.nombre = nombre;
	...
	public String toString() {
		return "\n Profesionista [nombre=" + nombre + ", apellido=" + apellido + ", edad=" + edad + ", cedula=" + cedula
